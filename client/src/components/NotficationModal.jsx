...
export default function NotficationModal({
  ...
  return (
    <div
      ...
      }  overflow-y-auto overflow-x-hidden fixed  flex glassy z-50  justify-center items-center w-full inset-0 h-screen max-h-full`}
    >
      <div className="relative p-4 sm:w-full max-w-2xl   max-h-full">
              ...
              {notifications?.map((notification) => (
                <>
                  <div
                    ...
                    className=" cursor-pointer w-full mb-8 rounded-lg bg-gray-200 p-5"
                  >
